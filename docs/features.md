...
| [Paths](api-reference.md#post-apipathplace) | Auto-stairs and platforms across z-levels | Yes |
...
| [Tiles](api-reference.md#get-apitiles) | Terrain, water, badwater, moisture, occupants. [ASCII map](api-reference.md#map) with height shading | Yes |
...
| [Workers](api-reference.md#post-apibuildingworkers) | Count, priority, pause, haul priority | Yes |
| [Distribution](api-reference.md#get-apidistribution) | Import/export per good, beaver migration between districts | Yes |
| [Production](api-reference.md#post-apibuildingrecipe) | Recipes, farmhouse action, forester priority | Yes |
| [Stockpiles](api-reference.md#post-apibuildingstorage) | Capacity and allowed goods per stockpile | Yes |
| [Floodgates](api-reference.md#post-apibuildingfloodgate) | Water gate height | Yes |
...
| [Water depth](api-reference.md#get-apitiles) | Water height float per tile for drought planning | Yes |
| [District per beaver](api-reference.md#get-apibeavers) | Which district each beaver/bot belongs to | Yes |
| [Badwater tiles](api-reference.md#get-apitiles) | Contamination level per map tile (badwater + soil) | Yes |
| [Map stacking](api-reference.md#get-apitiles) | Multiple occupants at different z-levels on same tile | Yes |
...
| [Filtering](api-reference.md#server-side-filtering) | Server-side name and proximity filtering on list endpoints | Yes |
...
| [Brain](api-reference.md#spatial-memory-cli-focused) | Live summary + persistent goal/tasks/locations for `/timberbot` and other advanced CLI workflows | Yes |
| [Placement distance](api-reference.md#post-apiplacementfind) | Flow-field path distance from DC on find_placement results for optimal building placement | Yes |
| [Path routing](api-reference.md#post-apipathplace) | Auto-stairs and platforms across z-levels, checks science unlocks | Yes |
